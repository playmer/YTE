...
namespace YTE
{
  YTEDefineType(Dx12Shader)
  {
    RegisterType<Dx12Shader>();
    TypeBuilder<Dx12Shader> builder;
  }

  Dx12Shader::Dx12Shader(DX12CreatePipelineDataSet& aInfo, DX12ViewData* aView)
    : Shader(aInfo.mName)
  ...
  DX12CreatePipelineDataSet Dx12Shader::CreateInfo(std::string &aName,
                                                 ...
                                                 bool aReload)
  {
    ...
    //
    //  DX12CreatePipelineDataSet ret(aName, errStr);
    //  return ret;
    //}
    //
    ...
    //    str));
    //
    //  DX12CreatePipelineDataSet ret(aName, str);
    //  return ret;
    //}
    //
    ...
    //
    //return DX12CreatePipelineDataSet(pipelineCache,
    //                               {},
    //                               vertexStage,
    //                               fragmentStage,
    //                               vertexInput,
    ...
    return DX12CreatePipelineDataSet{};
  }


  void Dx12Shader::Load(DX12CreatePipelineDataSet& aInfo)
  {
    UnusedArguments(aInfo);
  ...
  void Dx12Shader::Reload(DX12CreatePipelineDataSet& aInfo)
  {
    Load(aInfo);
  }
}
