...
namespace YTE
{
  ...
  VkCreatePipelineDataSet Dx12Shader::CreateInfo(std::string &aName,
  ...
  void Dx12Shader::Load(VkCreatePipelineDataSet& aInfo)
  {
  ...
  void Dx12Shader::Reload(VkCreatePipelineDataSet& aInfo)
  {
    Load(aInfo);
  }
}
