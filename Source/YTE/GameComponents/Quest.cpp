...
namespace YTE
{
  ...
  Conversation
  ******************************************************************************/
  Conversation::Conversation(Conversation::Name aName, Quest::Name aQuest, Quest::CharacterName aCharacter)
      ...
      switch (aQuest)
      {
        case Quest::Name::Introduction:
        {
          switch (aName)
          {
            ...
            {
              // LEVEL G
              DialogueData(dataG0, "John: Nice to meet you, though.", "John: I hope we bump into each other again!");
    ...
    else if (aCharacter == Quest::CharacterName::Daisy)
    {
      ...
      case Quest::Name::Fetch:
      {
        ...
        case Conversation::Name::Hello:
        {
          ...
          mNodeVec.emplace_back(DialogueNode::NodeType::Input, dataH0, 0);
          ...
          mNodeVec.emplace_back(DialogueNode::NodeType::Input, dataF0, 0);
          ...
          mNodeVec.emplace_back(DialogueNode::NodeType::Text, dataD0, 0);
          DialogueData(dataD1, "Daisy: Gotta cut loose when you can.");
          mNodeVec.emplace_back(DialogueNode::NodeType::Text, dataD1, 1);
          DialogueData(dataD2, "Daisy: Pull that thing!", "Daisy: Pull that other thing!", "Daisy: Sail faster!");
          mNodeVec.emplace_back(DialogueNode::NodeType::Text, dataD2, 2);
    ...
    else if (aCharacter == Quest::CharacterName::Basil)
    {
      ...
      case Quest::Name::Introduction:
      {
        ...
        case Conversation::Name::Hello:
        {
          ...
          mNodeVec.emplace_back(DialogueNode::NodeType::Text, dataF0, 0);

          // LEVEL E
          DialogueData(dataE0, "Nice to meet you");
          mNodeVec.emplace_back(DialogueNode::NodeType::Input, dataE0, 0);
      ...
      case Quest::Name::Fetch:
      {
        ...
        case Conversation::Name::Hello:
        {
          ...
          mNodeVec.emplace_back(DialogueNode::NodeType::Anim, dataB1, 1);
  ...
  ******************************************************************************/
  Quest::Quest(Quest::Name aName, Quest::CharacterName aCharacter)
    : mName(aName), mCharacter(aCharacter), mState(Quest::State::NotActive)
  {
    switch (aName)
    {
      case Quest::Name::Introduction:
      {
        mConversationVec.emplace_back(Conversation::Name::Hello, Quest::Name::Introduction, aCharacter);
        mConversationVec.emplace_back(Conversation::Name::PostQuest, Quest::Name::Introduction, aCharacter);
        break;
      }
      case Quest::Name::Fetch:
      {
        mConversationVec.emplace_back(Conversation::Name::Hello, Quest::Name::Fetch, aCharacter);
        mConversationVec.emplace_back(Conversation::Name::NoProgress, Quest::Name::Fetch, aCharacter);
        mConversationVec.emplace_back(Conversation::Name::Completed, Quest::Name::Fetch, aCharacter);
        mConversationVec.emplace_back(Conversation::Name::PostQuest, Quest::Name::Fetch, aCharacter);
        break;
      }
      case Quest::Name::Explore:
      {
        mConversationVec.emplace_back(Conversation::Name::Hello, Quest::Name::Explore, aCharacter);
        mConversationVec.emplace_back(Conversation::Name::NoProgress, Quest::Name::Explore, aCharacter);
        mConversationVec.emplace_back(Conversation::Name::Completed, Quest::Name::Explore, aCharacter);
        mConversationVec.emplace_back(Conversation::Name::PostQuest, Quest::Name::Explore, aCharacter);
        break;
      }
      case Quest::Name::Dialogue:
      {
        mConversationVec.emplace_back(Conversation::Name::Hello, Quest::Name::Dialogue, aCharacter);
        mConversationVec.emplace_back(Conversation::Name::NoProgress, Quest::Name::Dialogue, aCharacter);
        mConversationVec.emplace_back(Conversation::Name::Completed, Quest::Name::Dialogue, aCharacter);
        mConversationVec.emplace_back(Conversation::Name::PostQuest, Quest::Name::Dialogue, aCharacter);
        break;
      }
      case Quest::Name::NotActive:
      {
        mConversationVec.emplace_back(Conversation::Name::Hello, Quest::Name::NotActive, aCharacter);
      }
    }
  }
}//end yte