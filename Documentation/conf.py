...
breathe_default_project = 'YTE'
breathe_projects = { "YTE": "./doxygen/xml" }
...
project = u'YTE'
copyright = u'2019, Joshua T. Fisher'
author = u'Joshua T. Fisher'
...
htmlhelp_basename = 'YTEDocumentation'
...
latex_documents = [
  (master_doc, 'YTE.tex', u'YTE Documentation',
   u'Joshua T. Fisher', 'manual'),
]
...
man_pages = [
    (master_doc, 'yte', u'YTE Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'YTE', u'YTE Documentation',
   author, 'YTE', 'One line description of project.',
   'Miscellaneous'),
]
